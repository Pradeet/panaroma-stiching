function [result_img, H, num_inliers, residual] = stitch_pair (image, target_image, sift_r, harris_r, harris_thresh, harris_sigma, num_putative_matches, ransac_n)
...
[image_descriptor_loc, left_descriptors] = vl_sift_wrapper(image_bw, image_keypoint);
[target_image_descriptor_loc, right_descriptors] = vl_sift_wrapper(target_image_bw, target_image_keypoint);
